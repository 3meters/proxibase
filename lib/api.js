...
// If a post contains user and session params hoist them to req.qry
app.post('*', function(req, res, next){
  if (req.body && req.body.user) req.qry.user = req.body.user
  if (req.body && req.body.session) req.qry.session = req.body.session
  next()
})
