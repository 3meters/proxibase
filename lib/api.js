...
// Create and configure public app instance
var app = exports.app = express.createServer()
app
  .use(express.static(__dirname + '/public'))
  .use(express.bodyParser())  // parses json
  .use(app.router)


// Add error helper method
http.ServerResponse.prototype.sendErr = util.sendErr
...
app.all('*', function(req, res, next) {
  ...
  res.send = function(arg1, arg2, arg3) {
    ...
    if (arg1 && arg3 && typeof arg1 === 'string' && typeof arg3 === 'number') {
      ...
      log('==== Request ' + req.tag + ' time ' + req.time)
      // Log the request time in CSV format
      if (config.log.perf) {
        perfLog.write(req.tag + ',' + arg1.length + ',' + req.startTime + ',' + req.time + '\n')
      }
    }
  }
  next()
