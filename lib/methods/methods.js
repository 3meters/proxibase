...
module.exports.getEntities = function(entityIds, eagerLoad, beaconIds, res) {
  module.entityIds = entityIds
  module.beaconIds = beaconIds
  module.eagerLoad = eagerLoad
  module.res = res
...
function addBeaconLinks(parentEntityIds) {
  var query = null
  if (module.beaconIds) {
    query = {toTableId:3, _from:{$in:parentEntityIds}, _to:{$in:module.beaconIds}}
  }
  else {
