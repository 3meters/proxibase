...
function getEntitiesTracked() {
  ...
  db.collection('entities')
    ...
    if (entityIdsStale.length == 0) {
       ...
       */
      methods.getEntities(entityIdsStale, entityIdsCursor, req.body.eagerLoad, req.body.beaconIdsNew, req.body.observation, null, req.body.options, more, res)
    }
  })
}