...
var fs = require('fs')
  ...
  , authService = require('./routes/auth/main')
  , userService = require('./routes/user')
  , dataService = require('./routes/data').service // data service exports other methods
...
// /data or /data/:collectionName
app.all('/data/?', dataService(app))
