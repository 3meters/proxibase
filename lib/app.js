...
//var entities = require('./models/entities').Entities(mdb);
...
app.post('/_method', function(req, res) {
  ...
  console.log("_method called. req:" + util.inspect(req.body));
  var fn = req.body.name;

  this['hello'](req.body.params);
  // this.fn(req.body.params);
  // res.send(req.body);
