...
var util = require('util')
  ...
  , validateSession = require('./routes/auth').validateSession
...
// App routes
require('./routes/info').addRoutes(app)
require('./routes/user').addRoutes(app)
require('./routes/auth').addRoutes(app)
require('./routes/admin').addRoutes(app)
require('./routes/do').addRoutes(app)
require('./routes/data').addRoutes(app)
require('./routes/stats').addRoutes(app)
