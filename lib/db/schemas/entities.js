...
source.fields = {
  source:       { type: String },  // source provider: facebook, twitter, etc
  id:           { type: String },  // source provider's unique id
  url:          { type: String },  // optional www url to same resource
  name:         { type: String },  // optional display name
  icon:         { type: String },  // could be uri or client resource
  iconInverse:  { type: String },  // could be uri or client resource
  marketUri:    { type: String },  
  origin:       { type: String }, 
}
