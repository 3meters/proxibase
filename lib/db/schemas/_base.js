...
function setSystemFields(doc, previous, options, next) {
  util.log('setSystemsFields for ' + options.collectionName + ':', doc)
  ...
  util.log('setSystemsFields2 for ' + options.collectionName + ':', doc)
  next()
}
