...
var limitDefault = exports.limitDefault = 1000
var limitMax = exports.limitMax = 10000
...
var querySchema = {
  ...
  skip:       {type: 'number'},
  limit:      {type: 'number', default: limitDefault, validate: maxLimit},
...
function maxLimit(v) {
  log('limitMax is ' + limitMax)
  if (v > limitMax) return 'maximum limit is ' + limitMax
}
...
function extendMongodb() {
  ...
  Collection.prototype.safeFind = function() { // query, options, cb
    ...
    var options = {
      ...
      collections: this.db.schemaCollections
    }
