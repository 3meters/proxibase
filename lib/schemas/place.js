...
function merge(place, splace) {
  ...
  // accept the location with the greater reported accuracy
  if (splace.location && place.location && splace.location.accuracy) {
    if (!place.location.accuracy || place.location.accuracy < splace.location.accuracy) {
      splace.location = place.location
    }
  }
  return splace
}
