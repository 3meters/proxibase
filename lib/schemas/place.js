...
var place = {
  ...
  indexes: [
    { index: 'phone' },
    { index: 'provider.foursquare',  options: { sparse: true, unique: false }},
    { index: 'provider.factual',     options: { sparse: true, unique: false }},
    { index: 'provider.google',      options: { sparse: true, unique: false }},
    { index: 'provider.yelp',        options: { sparse: true, unique: false }},
