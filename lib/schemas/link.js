...
function tickleActivityDate(err, cb, doc, meta) {

  if (err) return cb(err)

  debug('tickle method', meta.options.method)
  debug('tickle link', doc)
  debug('tickle doc', meta.options.docTo)
  ...
  if (doc.inactive && previous.inactive) return finish()
