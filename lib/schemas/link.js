...
function decrementStats(doc, previous, options, next) {
  ...
  function decrementTos() {
    ...
    // last calculated
    db.sysvars.safeFindOne(lastToStatQuery, {asAdmin: true, tag: 'stats'}, function(err, lastStat) {
  ...
  function decrementFroms() {
    db.sysvars.safeFindOne(lastFromStatQuery, {asAdmin: true, tag: 'stats'}, function(err, lastStat) {
