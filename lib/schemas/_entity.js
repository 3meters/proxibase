...
var entity = {
  ...
  validators: {
    ...
    remove: [getStrongLinkedTo, preserveModified, getStrongLinkedFrom, updateActions, removeLinks],
  },
...
function updateActions(doc, previous, options, cb) {
  ...
  db.actions.safeRemove(query, {user: util.adminUser}, logDeleteAction)
