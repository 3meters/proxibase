...
var entity = {
  ...
  validators: {
    ...
    remove: [getStrongLinkedTo, preserveModified, getStrongLinkedFrom, removeActions, removeChildren, removeLinks],
  },
...
function removeActions(doc, previous, options, cb) {
  ...
  this.db.actions.safeRemove(query, {user: util.adminUser}, cb)
}
