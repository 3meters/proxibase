 ...
 *  Tasks schema
 *
 *    store and execute recurring tasks
 */
...
var taskSchema = {
  ...
  indexes: [
    { index: 'name', options: {unique: true} },
  ],
}
...
// Process message from the cluster master to start all tasks.
// This messages should only be received by one worker on
