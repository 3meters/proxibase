...
var action = {
  ...
  fields: {
    ...
    _fromEntity:        { type: 'string' },                                   // entity also effected by action
    _place:             { type: 'string' },                                   // ambient place identifier if available
  },
  ...
  indexes: [
    ...
    {index: { _place: 1 }},             // Used when searching for actions related to a place even if place is not directly part of the action
  ],
