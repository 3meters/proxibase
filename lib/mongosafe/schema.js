...
function extend(mongo) {
  ...
  Db.prototype._collection = Db.prototype.collection  // stash super
  Db.prototype.collection = function(collectionName) {
    if (this.safeCollections && this.safeCollections[collectionName]) {
      ...
      return Db.prototype._collection.apply(this, arguments) // passthrough
    }
  }
...
function initSchema(schema, cb) {
  ...
  // Ensure that there are no name conflicts with existing schemas or collections
