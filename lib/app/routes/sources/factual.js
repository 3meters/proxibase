...
function getByPartnerId(options, cb) {
  log('debug factual by partner options', options)
  ...
  util.callService.factual(search, function(err, res) {
    ...
    getByFactualId(options, cb)
  })
}

function getByFactualId(options, cb) {
  log('debug factual by factual options', options)
  var newSources = options.newSources
  var raw = options.raw
  var query = options.query
  var search = {
...
exports.getByPartnerId = getByPartnerId
exports.getByFactualId = getByFactualId
