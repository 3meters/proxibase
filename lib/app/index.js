...
function init() {
  ...
  app.use('/v1/do/registerInstall', ignoreBogus())
...
// Send an error to bogus client requests before the logger runs
function ignoreBogus() {
  return function(req, res, next) {
    ...
    if ((install.clientVersionCode === 120 &&
      ...
      // Return an error with a hint not to log the response
      req.doNotLogResponse = true
      return res.error(perr.badRequest('Please reinstall Patchr'))
    }
    next()
  }
}
