...
function addPreRoutes(app) {
  ...
  function processBody(req, res, next) {
    if (req.body) {
      ...
      if (req.body.location && !req.query.location) req.query.location = req.body.location
      if (req.body.install && !req.query.install) req.query.install = req.body.install
      if (req.body.beaconIds && !req.query.beaconIds) req.query.beaconIds = req.body.beaconIds
    }
    next()
  }
