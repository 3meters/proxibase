...
function init() {
  ...
  // TODO: remove both of these next lines as soon as the client
  // has migrated to always use /v1/assets to get its static files
  app.use(serveStatic(path.join(__dirname, '../../assets')))
  app.use('/v1', serveStatic(path.join(__dirname, '../../assets')))
