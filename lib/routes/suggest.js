...
function addRoutes(app) {
  ...
  app.get('/suggest/users/?', main)
  app.post('/suggest/users/?', main)
  app.get('/suggest/places/?', main)
  app.post('/suggest/places/?', main)
}
...
function run(req, options, cb) {
  ...
  // Find using full text search, stems, but matches on whole words only
  findStoredPlacesFts()
