...
module.exports = function(req, arg1) {

  var callback = (typeof arg1 === 'function') ? arg1 : send
  var selector = {}
  var options = {}
  var searchNames = []
  var allFields = []
  ...
  function send(err, results) {
    var res = arg1
    assert(res.send && res.error, 'Invalid call to find')
    if (err instanceof Error) return res.error(err, results)
