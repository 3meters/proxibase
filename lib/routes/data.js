  ...
  switch (req.method) {
    ...
    case 'post':
      ...
      if (req.body && req.body.data) {
        ...
        // Our own schema check  TODO: move to base schema
...
exports.get = function(req, res) {
  ...
  if (req.qry.sort) {
    options.sort = req.qry.sort
  }

  if (req.qry.skip) {
    options.skip = req.qry.skip
  }
...
exports.create = function(req, res) {
  ...
  doc.save(function (err, savedDoc) {
    ...
    var data = savedDoc
    if (req.body.terse) data = savedDoc._id
    res.send({
...
exports.update = function(req, res) {
  ...
  var query = req.model.findOne({ _id: docId }, function (err, doc) {
    ...
    doc.save(function(err, updatedDoc) {
      ...
      var data = updatedDoc
      if (req.body.terse) data = updatedDoc._id
      res.send({
