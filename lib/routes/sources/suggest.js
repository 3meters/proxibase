...
function run(ops, cb) {
  ...
  if (!oldSources.length && ops.place && ops.place.provider && ops.place.id &&
  ...
  if (!oldSources.length) return cb(null, oldSources, raw)
