...
function normalize(source) {
  ...
  log('debug website normalized', source)
  return source
}
...
function get(source, scope, cb) {
  ...
  log('debug website.get called source:', source)
  log('debug website.get called scope:', scope)
  ...
  request.get(reqOps, function(err, res) {
    ...
    log('debug website calling back now:  scope:', scope)
    cb(null, source)
  })
}
