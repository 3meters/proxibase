...
invite = function(req, res) {
  ...
  var _body = {
    emails:   {
      ...
      validate: function(v) {
        ...
        else return perr.missingParam('email')
      }
    },
  ...
  // Read the error template from disk.  Doing this for each request
  // rather than once at startup allows us to update the content without
  // bouncing the server
