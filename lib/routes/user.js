...
exports.init = function() {
  log('appDir: ', util.appDir)
  debugger
  inviteMsg = fs.readFileSync(path.join(util.appDir, 'assets/html/invite.html'), 'utf-8')
  log('inviteMsg: ', inviteMsg)
}
...
invite = function(req, res) {
  var errors = []
  var _body = {
    emails:   {type: 'array', required: true, value: {type: 'string'}},
    name:     {type: 'string'},
    message:  {type: 'string'},
  }
  var body = req.body
