/**
 * routes/stats.js wire up the stats routes
 *
 *
 *        get /stats/<stat>
 *
...
exports.init = function() {
  ...
  greeting = {
    ...
    params: 'same find syntax as /find.  Set refresh=true to regenerate stat (requires admin)',
    stats: {}
  }
...
var getStat = exports.getStat = function(req, res) { // arg can be cb or response object
  ...
  if (tipe.isUndefined(req.query.refs)) findOps.refs = 'name'
...
function genLinksFromUsers(req, cb) {
  ...
  function processResults(err, results) {
    ...
    db.initSchema(schema, true, function(err) {
      if (err) return cb(err)
