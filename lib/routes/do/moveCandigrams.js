...
module.exports.main = function(req, res) {
  ...
  run(params, function(err, places, errors, activityDate, notifications) {
    if (err) return res.error(err)
...
var run = exports.run = function(params, cb) {
  ...
  function process() {
    ...
    function notify(options, next) {
      ...
      if (!params.expand) notification.fromId = options.currentPlaceId
      /*
  ...
  function done(err) {
    ...
    cb(err, places, errors, activityDate, notifications)
  }
