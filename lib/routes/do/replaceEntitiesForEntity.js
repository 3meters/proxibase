 ...
 *
 * Note: Current logic only allows replacing applinks for a place.
 */
...
exports.main = function(req, res) {
  ...
  function insertLinks() {
    ...
    async.forEachSeries(insertedEntities, insertLink, updatePlace)
  ...
  function updatePlace() {
    ...
    db.places.safeUpdate(placeUpdate, adminModify, logAction)
  }


  function logAction(err) {
    if (err) return res.error(err)

    action.event = 'update_entities' + '_' + req.body.schema + '_for_' + entity.schema
