...
exports.main = function(req, res) {
  ...
  if (req.body.source === 'factual') {
    ...
    var entities = []
    var query = {$circle: {$center: [body.latitude, body.longitude], $meters: body.radius}}
  ...
  if (body.source === 'foursquare') {
    ...
    var path = 'search?ll=' + body.latitude + ',' + body.longitude +
      '&radius=' + body.radius + '&limit=' + body.limit
