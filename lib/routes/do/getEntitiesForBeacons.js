              ...
              if (!beacons[i].latitude || !beacons[i].longitude || !beacons[i].accuracy || !beacons[i].level) {
                ...
                if (distanceInKm >= 0.2) {
                  ...
                  updateReason = 'distance'
                    ...
                    (observation.accuracy < beacons[i].accuracy || !beacons[i].accuracy)) {
                  updateLocation = true
                  updateReason = 'accuracy'
                }
                else if (observation.accuracy <= 30 &&
  ...
  function getEntitiesTracked() {
    ...
    db.entities
      ...
      if (entityIdsStale.length == 0) {
         ...
         */
        methods.getEntities(entityIdsStale, req.body.eagerLoad, req.body.beaconIdsNew, req.body.observation, null, req.body.options, more, req, res)
      }
    })
  }
}
