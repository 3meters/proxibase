...
exports.notify = function (notification) {
  ...
  function checkForWatchNotifications(notification, registrationMap) {
    ...
    logErr('WARNING: Watch Notifications Has Been Disabled')  // turning off for new schema migration
    return
...
var propogateActivityDate = module.exports.propogateActivityDate = function (entityId, activityDate) {
   ...
   */
  logErr('WARNING:  PropogateActivityDate has been disabled') // Turing off until migrated to new schema --george
  return 
