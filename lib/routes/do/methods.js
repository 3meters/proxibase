...
exports.sendMessage = function (message, cb) {
  ...
  function supportedMessage(message) {
    ...
    if (message.entity.schema === util.statics.schemaMessage && message.event.indexOf('insert') === 0) return true
    ...
    if (message.entity.schema === util.statics.schemaCandigram && message.event.indexOf('forward') === 0) return true
    return false
  }
