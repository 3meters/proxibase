...
exports.notify = function (notification) {
  ...
  log('notification to process: ' + JSON.stringify(notification, null, 2))
  ...
  function finishNotification() {
    ...
    log('notification to send: ' + JSON.stringify(notification, null, 2))

    var types = ['nearby', 'create', 'create_to', 'watch', 'watch_to', 'watch_user']
