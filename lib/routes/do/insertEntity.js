...
module.exports.main = function(req, res) {
  ...
  function checkAnonUser() {
    if (req.dbOps.user) return doInsertEntity()
  ...
  function insertBeacons() {
    ...
    db.beacons.safeUpsert(req.body.beacons, req.dbOps, createdLink)
    /*
  ...
  function createdLink(err) {
    ...
    // short curcut as this is being composted into _schemas/_entity
    return insertLinks()
  ...
  function insertLinks(err) {
    ...
    function insert(link, next) {
      ...
      db.links.safeInsert(link, req.dbOps, next)
    }
