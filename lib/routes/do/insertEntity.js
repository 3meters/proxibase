...
module.exports.main = function(req, res) {
  ...
  if (req.body.suggestTimeout && typeof req.body.suggestTimeout !== 'number') { // in seconds default 5
 ...
 *   @entity.sources [{
 *     type: <sourceType> facebook, twitter, website, etc
 *     id: <id>  
 *   }]
 */
...
function insertLinks(req, res) {
  if (req.body.parentId) {
     ...
     */
    log('Logging action for linkless entity: ' + req.insertedEntity._id)
    methods.logAction(req.insertedEntity._id, 'aircandi', "tune_entity_location", req.user._id, req.body.observation ? req.body.observation : null, req)
    updateActivityDate(req, res)
  }
}
