...
module.exports.main = function(req, res) {
   ...
   *   }]
   */
  function suggestApplinks() {
    var entity = req.body.entity
    if (!(req.body.suggestApplinks && entity.type === util.statics.typePlace)) {
    ...
    log('calling applinks suggest method')
  ...
  function doInsertEntity() {
    var entity = req.body.entity
    var actionType = 'insert_entity' + '_' + entity.type
    var collectionName = req.body.entity.type + 's'

    /* System is default owner for place entities except custom ones */
    var options = {user: req.user}
    if (entity.type === util.statics.typePlace) {
