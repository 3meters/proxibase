...
module.exports.main = function(req, res) {
          ...
          db.applinks.safeUpsert(applink, req.dbOps, function(err, savedApplink, meta) {
            ...
            if ('update' === meta.method) {  // meta = {method:'insert|update'}
              ...
              var link = {
                ...
                _to: entity._id,
                type: util.statics.typeContent, // TODO:  this makes up for a problem in get entities.
              }
  ...
  function insertLinks() {
    ...
    else if (req.body.beacons && req.savedEntity.schema === util.statics.schemaPlace) {
      /*
  ...
  function beaconsForNotify() {
    if (req.savedEntity.schema === util.statics.schemaPlace || !req.body.link) {
      notify()
    }
    else {
      /*
