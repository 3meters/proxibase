...
module.exports.main = function(req, res) {
  ...
  req.dbOps = {user: req.user}  // place schema trigger sets admin as owner for synthetic places
  ...
  function doInsertEntity() {
    ...
    if (req.body.link) {
      var toId = util.parseId(req.body.link._to)
  ...
  function beaconsForMessage() {
    ...
    if (!req.user || req.user._id != req.savedEntity._owner) return done()
  ...
  function sendMessage() {
    ...
    if (req.body.link) {
      message.toId = req.body.link._to
    }
