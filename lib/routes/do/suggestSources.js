      ...
      callService.factual(path, function(err, res) {
        ...
        data.forEach(function(elem) {
          ...
          newSources.push({
            ...
            url: elem.url,
            name: elem.namespace,
            icon: 'resource:source_' + elem.namespace,
            iconInverse: 'resource:source_' + elem.namespace
          })
        })
        next()
      })
    ...
    request({uri: uri, json: false}, function(err, sres, body) {
      ...
      $('a[href*="facebook.com"]').each(function(i, elem) {
        newSources.push({
          ...
          name: $(this).text(),
          icon: 'resource:source_facebook',
          iconInverse: 'resource:source_facebook',
        })
      })
      $('a[href*="twitter.com"]').each(function(i, elem) {
        newSources.push({
          ...
          id: '@' + prune(url.parse($(this).attr('href')).path),
          name: $(this).text(),
          icon: 'resource:source_twitter',
          iconInverse: 'resource:source_twitter',
        })
      })
      $('a[href*="yelp.com"]').each(function(i, elem) {
        newSources.push({
          ...
          id: prune(url.parse($(this).attr('href')).path),
          name: $(this).text(),
          icon: 'resource:source_yelp',
          iconInverse: 'resource:source_yelp',
        })
      })
      $('a[href^="mailto:"]').each(function(i, elem) {
        newSources.push({
          ...
          name: $(this).text(),
          icon: 'resource:source_email',
          iconInverse: 'resource:source_email',
        })
      })
      next()
    })
