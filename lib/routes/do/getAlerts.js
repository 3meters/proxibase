...
var run = exports.run = function(req, options, cb) {
  ...
  function findFroms() {
    ...
    //   $or: [
    //     { _to:        { $in: seedIds },
    //       type:       { $in: [statics.typeContent, statics.typeWatch] },
    //       _creator:   { $ne: options.entityId },
    //       fromSchema: { $in: [statics.schemaMessage, statics.schemaUser] },
    //     },
    ...
    //       type:       { $in: [statics.typeWatch, statics.typeContent] },
    //       _creator:   { $ne: options.entityId },
    //       fromSchema: { $in: [statics.schemaUser, statics.schemaMessage] },
    //     },
    //     { _to:        { $in: seedWatchIds },
