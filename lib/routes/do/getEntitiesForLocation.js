...
exports.main = function(req, res) {
  ...
  if (!req.body.radius) {
    req.body.radius = (0.25 / 3959) /* Quarter mile */
  }
  ...
  function loadEntities() {
      if (entityIdsToProcess.length == 0) {
        ...
        methods.getEntities(entityIdsToProcess, req.body.eagerLoad, req.body.beaconIdsNew, null, req.body.options, more, req, res)
      }
  }
}
