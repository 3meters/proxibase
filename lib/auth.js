...
module.exports.start = function(config) {
  ...
  function validateSession(req, res, next) {
    ...
    users.findOne({ _id: req.qry.user }, function(err, user){
      ...
      // TODO:  The following will break for valid user logging in from different Ips
      // need to store client IP as part of session and create new session for
      // a valid user from a different client IP
      sessions.findOne({ key: req.qry.session }, function(err, session) {
