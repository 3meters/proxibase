...
// warning: this code is untested.  Running may put your
// server on a spammers list
/*
if ('production' === service.mode) {
  transport.useDKIM({
    domainName: service.host,
    keySelector: 'dkim',
    privateKey: fs.readFileSync(service.ssl.keyFilePath),
  })
}
*/
