 ...
 *
 *     res.error(proxErr.notFound(msg, info))    // very clear
 *     res.error(perr.notFound(msg, info))       // briefer
 *     res.error(404)                            // dead quick, no params
 *     res.error(400.3)                          // works fine, head-scratching to read
 */
...
exports.proxErr = proxErr
exports.ProxErr = ProxErr
exports.proxErrMap = errMap
exports.proxErrCodeMap = errCodeMap
