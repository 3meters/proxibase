...
exports.genId = function(schemaId, timeUTC) {
  ...
  assert(parseInt(schemaId, 10) >= 0, "Invalid schemaId")
...
exports.parseId = function(idStr) {
  var collectionIdMap = statics.collectionIdMap
  var id = {}, sep = '.', parts = []
