...
console.log('mongodb prototype:')
console.log(Object.getPrototypeOf(mongodb))
...
mongodb.createSchema = function(s1, s2) {
  ...
  schema.indexes = schema.indexes.concat(s1.indexes)
  schema.indexes = schema.indexes.concat(s2.indexes)
  extend(schema.validators, s1.validators)
