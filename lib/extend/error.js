 ...
 *     res.error(new HttpErr(httpErr.notFound, msg, errs))  // legacy
...
function exportGlobals() {
  ...
  // Preferred: res.error(proxErr.notFound(msg))
  global.proxErr = proxErr

  // Legacy: res.error(new HttpErr(httpErr.notFound, msg))
  global.HttpErr =
  global.ProxErr = ProxErr
  global.httpErr = errMap

  // Map of errors templates by code:  res.error(404)
  global.errCodeMap = errCodeMap
 ...
 */
function ProxErr(template, callerMessage, callerErrors) {
