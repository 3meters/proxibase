...
// Async flow-control lacking only my-ness
Array.prototype.forEachAsync = require('futures').forEachAsync
...
function startAppServer() {
  ...
  /*
  util.gdb.models.forEach(function(model){
...
/*
 *  If the server was started with nodemon this will force a server stop / restart
