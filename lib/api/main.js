...
var
  ...
  config = util.config,
  gdb = util.gdb,
  authService = require('./auth/auth'),
  userService = require('./user'),
  dataService = require('./data'),
  doService = require('./do/main'),
  app,
  info = {},
...
app
  .use(express.static(__dirname + '/../www/public'))
  .use(middleware.tagger())
...
app.all('/auth/:method/:service', authService.oauth)
...
app.post('/auth/signout', authService.signout)
*/
...
// Patch for client bug https://github.com/Jaymassena/aircandi/issues/138
// TODO: remove
