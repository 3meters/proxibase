...
var
  ...
  uid1 = _schemas.user + '.' + timeStamp + '.000001',                     // Standard user
  uid2 = _schemas.user + '.' + timeStamp + '.000002',                     // Dev user
  bssid = '00:00:00:00:00:01',
  beaconId = _schemas.beacon + '.' + bssid,
  applinkId = _schemas.applink + '.' + timeStamp + '.000001',
  commentId = _schemas.comment + '.' + timeStamp + '.000001',
  placeId = _schemas.place + '.' + timeStamp + '.000001',
  postId = _schemas.post + '.' + timeStamp + '.000001',
  documentId = _schemas.document + '.' + timeStamp + '.000001',
  linkId = _schemas.link + '.'  + timeStamp + '.000001',
  deviceId = _schemas.device + '.'  + timeStamp + '.000001',
